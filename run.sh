...
./mandelbrot/mandelbrot ${common_args}-10.bmp -b32768 -z1.0e-3 -x 0.77000000 -y 0.11000000 --distance=6
./mandelbrot/mandelbrot ${common_args}-11.bmp -b65536 -z1.0e-3 -D -x 0.77000000 -y 0.11000000 --color-distance -p2 --negate
./mandelbrot/mandelbrot ${common_args}-12.bmp -b65536 -z4 --formula sin --distance=8 --color-distance -p4
